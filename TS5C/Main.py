...
def main():
    ...
    for line in file_graph:
        # if cnt%10000==0:
        #     print cnt, cliques_seen, wedge_reservoir.total_4cliques,wedge_reservoir.cliques_seen, wedge_reservoir.get_number_squares()
        ...
        wedge_reservoir.update_4cliques(u, v)
